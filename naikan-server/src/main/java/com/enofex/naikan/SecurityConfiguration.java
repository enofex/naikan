...
import com.enofex.naikan.security.token.TokenRepository;
...
class SecurityConfiguration {
  ...
  static class LdapSecurityConfiguration {
    ...
    LdapSecurityConfiguration(UserRepository userRepository, NaikanProperties properties) {
    ...
    AuthenticationProvider ldapAuthenticationProvider(LdapContextSource contextSource) {
      ...
      provider.setUserDetailsContextMapper(new DefaultLdapUserDetailsMapper(this.userRepository));
    ...
    AuthenticationSuccessHandler authenticationSuccessHandler() {
      return new HttpStatusReturningAuthenticationSuccessHandler(this.userRepository);
    }
  ...
  static class ApiSecurityConfiguration {
    ...
    ApiSecurityConfiguration(TokenRepository tokenRepository) {
    ...
    SecurityFilterChain apiSecurityFilterChain(HttpSecurity http) throws Exception {
      http
          ...
          .addFilterBefore(
              new BearerTokenAuthenticationFilter(this.tokenRepository),
